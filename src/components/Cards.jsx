...
const Cards = () => {
  return (
    <>
      ...
      <h3 className="text-center text-4xl text-black mt-8  mb-4 font-extrabold">Sale</h3>
      <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 px-8 py-8">
        {products.map((product) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-blue-500  text-[20px] font-semibold mt-2">{product.price}</p>
            </div>
          </div>
       ...
       <button
      className="w-32 h-12 sm:w-36 sm:h-9 md:w-40 md:h-10 bg-blue-400 border rounded-full border-blue-400 text-white transition duration-300 ease-in-out hover:text-black hover:bg-transparent hover:border-black  animate-fadeUp opacity-0 delay-700 text-sm sm:text-base"
    >
      View More
    </button>
       </div>
